---
title: |
  Title: Tumour size and overall survival in glioblastoma: a prognostic modelling and resampling study
author:
  - Kavi Fatania:
...
**Figure \@ref(fig:boxplotdiam) - \@ref(fig:boxplotcore)** -- *Each plot shows the distribution of p-values extracted from each model created across the 1,000,000 repetitions for each sample size. For each tumour size parameter, the p-value distributions for models before and after log-transformation are shown side by side (see figure legends). Dotted lines indicate the 0.05 significance level.* 
