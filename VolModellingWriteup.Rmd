...
Various candidate glioblastoma (GBM) prognostic models have shown inconsistent effects of tumour size. Rather than build a prognostic model, the purpose of this study was to investigate the prognostic effect of tumour size in a large, well-curated cohort of patients diagnosed with GBM and interrogate how choice of sample size and consideration of non-linear transformations may impact on the likelihood of finding a univariable and multivariable prognostic effects using data resampling.

[Methods]{.underline}

279 patients (mean age 61 years, 39% female) with IDH-wildtype unifocal WHO grade 4 GBM and pre-operative MRI between 2014-2020 were retrospectively included. Tumours were segmented using deep-learning with manual correction and manual diameter measurements. Univariable and multivariable association between core volume, whole volume (CV, WV) and diameter to OS was assessed with (1) Cox proportional hazard models, with and without log transformation and (2) resampling of data with 1,000,000 repetitions and varying sample size to identify percentage of models with significant effects of tumour size.

[Results]{.underline}

Multivariable models adjusted for operation type using any size variable were significant, and diameter adjusted for all variables remainded significant (p=0.03). Resampling increased significant effects (p\<0.05) of all size variable as sample size increased, and when WV was log-transformed, especially in the multivariable models. For models adjusted for surgery extent, 19.5% of WV vs 26.3% log-WV (n=50) and 69.9% WV and 89.9% log-WV (n=279) were significant.
...
* Multivariable resampling experiments showed that increasing sample sizes raised the chance of detecting a signficant prognostic effect diameter or volume - diameter was prognostic in 19.5% models for n=50, but in 55.7% at n=279.

* Multivariable resampling of whole volume (core + peritumoural oedema) showed a large impact on the chance of detecting a prognostic relationship with log-transformation - whole volume was prognostic in 24.6% models without and 45.7% of models with transformation (n=279). 
...
**Glioblastoma size is inconsistently associated with survival, but our uni-/multivariable and resampling analysis support the hypothesis that limited sample size, lack of data transformation or reliance on univariable associations may help explain some of this heterogeneity.**
...
There are a number of ways to select predictors for multivariable prognostic modelling and to evaluate the uncertainty or instability that might arise from choosing predictors in small samples or using univariable significance[@Harrell2015;@Riley2019b]. This includes the use of internal validation strategies such as data resampling (ie. bootstrapping) to estimate uncertainty in effect size and predictor selection, but this is infrequently assessed in the prognostic modelling of GBM survival despite its importance[@Tewarie2021].


Rather than build a candidate prognostic model, the purpose of this study was to investigate the prognostic effect of tumour size in a large, well-curated cohort of patients diagnosed with GBM and interrogate how choice of sample size and consideration of non-linear transformations may impact on the likelihood of finding a univariable and multivariable prognostic effects using data resampling.
