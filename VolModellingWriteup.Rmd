...
```{r boxplotdiam,fig.cap='Boxplots of p-values from resampling study for tumour diameter models',echo=FALSE, dpi=300,fig.height=7.5,fig.width=10,out.height=450,out.width=600}
GrpBxplot(diam,log.diam,Samp_sizes,"Tumour Diameter")
```

```{r boxplotwtv,fig.cap='Boxplots of p-values from resampling study for whole tumour volume (WTV) models', echo=FALSE,dpi=300,fig.height=7.5,fig.width=10,out.height=450,out.width=600}
GrpBxplot(wtv,log.wtv,Samp_sizes,"Whole tumour volume")
```

```{r boxplotcore,fig.cap='Boxplots of p-values from resampling study for core tumour volume (CTV) models', echo=FALSE,dpi=300,fig.height=7.5,fig.width=10,out.height=450,out.width=600}
